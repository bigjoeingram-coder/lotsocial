...
export function buildVerticalRenderPlan(project: CreativeProjectRecord, vehicle: ImportedVehicleRecord) {
  ...
  const endCardPhone = project.end_card_phone ? `<strong>${escapeHtml(project.end_card_phone)}</strong>` : "";
  const endCardEmail = project.end_card_email ? `<strong>${escapeHtml(project.end_card_email)}</strong>` : "";
  ...
  const endCardCss = "html,body{margin:0}.end-card{box-sizing:border-box;position:relative;width:1080px;height:1920px;font-family:Arial,Helvetica,sans-serif;color:white;text-align:center;background:linear-gradient(180deg,#071116 0%,#101f24 58%,#05090b 100%);overflow:hidden}.content{position:absolute;left:150px;right:150px;top:545px}.brand{display:block;margin:0 auto 140px;color:#c8ff43}.brand span{display:inline-block;width:70px;height:70px;line-height:70px;border-radius:16px;background:#c8ff43;color:#17242a;font-size:46px;font-weight:900;vertical-align:middle;transform:rotate(-4deg)}.brand b{display:inline-block;margin-left:14px;color:#c8ff43;font-size:36px;letter-spacing:.08em;text-transform:uppercase;vertical-align:middle}.end-card p{max-width:780px;margin:0 auto 24px;color:#c8ff43;font-size:34px;line-height:1.1;font-weight:900;letter-spacing:.02em;text-transform:uppercase;overflow-wrap:anywhere}.end-card h1{max-width:780px;margin:0 auto 26px;font-size:60px;line-height:1;letter-spacing:-.03em;overflow-wrap:anywhere}.contact{max-width:780px;margin:0 auto}.end-card strong{display:block;margin:8px auto 0;color:#e8f1eb;font-size:26px;line-height:1.22;font-weight:750;overflow-wrap:anywhere}.end-card small{display:block;max-width:760px;margin:80px auto 0;color:#9fb0a7;font-size:20px;line-height:1.28;overflow-wrap:anywhere}";
  const render = {
    timeline: {
      background: "#17242a",
      tracks: [
